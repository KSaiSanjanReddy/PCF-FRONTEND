...
const Components: React.FC = () => {
  ...
  const [editingItem, setEditingItem] = useState<ComponentData | null>(null);
  ...
  const [itemToDelete, setItemToDelete] = useState<ComponentData | null>(null);
  ...
  const getCurrentSetter = () => {
    switch (activeTab) {
      case "type":
        return setComponentTypes;
      case "category":
        return setComponentCategories;
      default:
        return setComponentTypes;
    }
  };
  ...
  const handleDeleteClick = (item: ComponentData) => {
  ...
  const getCodeTitle = () => {
    switch (activeTab) {
      ...
      case "category":
        return "Component Category Code";
      default:
        return "Component Type Code";
    }
  };
          ...
          <div className="px-6 pt-4 flex justify-between items-center">
            <div className="flex space-x-8 border-b border-gray-200 mb-5">
              {[
                ...
                { key: "category", label: "Component Category" },
              ].map((tab) => (
                <button
                  key={tab.key}
