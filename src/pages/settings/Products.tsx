...
const Products: React.FC = () => {
  ...
  const [productTypes, setProductTypes] = useState<ProductData[]>([
    {
      id: "1",
      code: "CHS001",
      name: "Chassis",
  ...
  >([
    {
      ...
      code: "SUB001",
      name: "Sensors",
      description: "Various types of sensor components",
    },
    {
      id: "2",
      code: "SUB002",
      name: "Controllers",
      description: "Control units and processing modules",
    },
    {
      id: "3",
      code: "SUB003",
      name: "Connectors",
      description: "Connection and interface components",
    },
  ]);
  ...
  const getCurrentSetter = () => {
    switch (activeTab) {
      case "type":
        return setProductTypes;
      case "category":
        return setProductCategories;
      case "subcategory":
        return setProductSubCategories;
      default:
        return setProductTypes;
    }
  };
  ...
  const getCodeTitle = () => {
    switch (activeTab) {
      ...
      case "subcategory":
        return "Product Sub-Category Code";
      default:
        return "Product Type Code";
    }
  };
  ...
  const getNameTitle = () => {
    switch (activeTab) {
      ...
      case "subcategory":
        return "Product Sub-Category Name";
      default:
        return "Product Type Name";
    }
  };
      ...
      <div className=" p-8">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Define main categories for your products.
                  </p>
                </div>
              </div>
          ...
          <div className="px-6 pb-6">
            ...
            {/* {editingItem && (
              <div className="mb-4 bg-blue-50 border border-blue-200 rounded-lg p-3 flex items-center space-x-2 animate-in slide-in-from-top-2 duration-200">
                            ...
                            <td className="px-6 py-4 text-center">
                              <div className="flex items-center justify-center space-x-2">
                                <button
                                  ...
                                  className="bg-green-600 hover:bg-green-700 cursor-pointer disabled:bg-gray-400 disabled:cursor-not-allowed text-white px-3 py-1.5 rounded-lg text-sm font-medium transition-all duration-200 hover:shadow-md disabled:hover:shadow-none flex items-center space-x-1"
                                ...
                                <button
                                  onClick={handleCancelEdit}
                                  className="bg-gray-500 hover:bg-gray-600 text-white px-3 py-2.5 cursor-pointer rounded-lg text-sm font-medium transition-all duration-200 hover:shadow-md"
                                  title="Cancel (Esc)"
                                >
                                  <X className="h-3 w-3" />
                                </button>
